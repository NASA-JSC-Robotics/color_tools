...
// TODO: These were copied from roboplan-ros, but could be moved someplace common.
// https://github.com/open-planning/roboplan-ros/blob/main/roboplan_ros_cpp/include/roboplan_ros_cpp/bindings.hpp
...
ROSMsgType pyToCppMsg(nb::handle py_msg)
{
