...
NB_MODULE(bindings, m)
{
  ...
  m.def(
      "process_blobs",
      [](nb::handle color_image_msg, nb::handle depth_image_msg, nb::handle camera_info_msg,
         nb::handle blob_request_msg, nb::object blob_result_class) {
      ...
      "color_image"_a, "depth_image"_a, "camera_info"_a, "request"_a, "result_class"_a,
