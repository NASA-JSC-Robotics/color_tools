...
private:
    ...
    void convertImageToROS(std_msgs::msg::Header header, cv::Mat &input, const char encoding[], sensor_msgs::msg::Image &output); //given a header, cv::Mat, and image encoding, create a ROS image 
    /* Services */
