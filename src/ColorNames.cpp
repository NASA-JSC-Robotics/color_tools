...
const char* const ColorNames::colorName[] = {"black", "blue",   "brown", "grey",  "green", "orange",
                                             "pink",  "purple", "red",   "white", "yellow"};

const cv::Vec3b ColorNames::colors[] = {cv::Vec3b(0, 0, 0),       cv::Vec3b(255, 0, 0),   cv::Vec3b(0, 75, 150),
...
{
    uint16_t idx = static_cast<uint16_t>(std::floor(static_cast<float>(colorA[2]) / 8.0) +
